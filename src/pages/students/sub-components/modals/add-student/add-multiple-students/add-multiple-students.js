...
const AddMultipleStudentsModal = ({isOpen, closeModal}) => {
    ...
    const {mutateAsync: addMultipleStudents, isLoading: addMultipleStudentsLoading} = useAddMultipleStudents()
    ...
    const requestSubmit = async () => {
        ...
        await addMultipleStudents(formData).then(() => {
        closeModal()
        })
    }
            ...
            >
                <div className='flex gap-3 items-center justify-between'>
                    <div className='flex flex-col justify-center item-start gap-3 w-full'>
                        ...
                        >
                            <div className='text-[15px] font-bold w-1/2'>Bulk upload students</div>
                ...
                <div className='flex justify-end mt-8 -mx-4'>
                    <div className='flex justify-end w-full'>
                        <AppButton
                            ...
                            text={'Save & Close'}
                            loading={addMultipleStudentsLoading}
                        />
                    </div>
                </div>
            </Form>
...
export default AddMultipleStudentsModal;