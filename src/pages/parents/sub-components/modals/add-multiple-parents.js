...
import { FileUploaderDropContainer, FileUploaderItem, Form, Modal } from 'carbon-components-react';
...
const AddMultipleParentsModal = ({isOpen, closeModal}) => {
    ...
    const {mutateAsync: addMultipleParents, isLoading: addMultipleParentsLoading} = useAddMultipleStudents()
    ...
    const requestSubmit = async () => {
        ...
        await addMultipleParents(formData).then(() => {
        closeModal()
        })
    }
            ...
            <Form onSubmit={handleSubmit(requestSubmit)}>
                <div className='flex gap-3 items-center justify-between'>
                    <div className='flex flex-col justify-center item-start gap-3 w-full'>
                        ...
                        >
                            <div className='text-[15px] font-bold w-1/2'>Bulk upload parents</div>
                ...
                <div className='flex justify-end mt-8 -mx-4'>
                    <div className='flex justify-end w-full'>
                        <AppButton
                            ...
                            text={'Save & Close'}
                            loading={addMultipleParentsLoading}
                        />
                    </div>
                </div>
            </Form>
