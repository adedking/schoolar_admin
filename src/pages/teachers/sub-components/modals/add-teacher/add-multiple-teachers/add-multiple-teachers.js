...
const AddMultipleTeacherModal = ({isOpen, closeModal}) => {
                    ...
                    <Stack gap={5}>
                        <div className='flex gap-3 items-center justify-between'>
                            <div className='flex flex-col justify-center item-start gap-4 w-full'>
                                <FormLabel className='text-[15px] font-bold'>Select  - (Optional)</FormLabel>
...
export default AddMultipleTeacherModal;