...
import { useGetAttendancesBySubject } from '../../../redux/attendance-register/hook';

const SubjectAttendanceView = ({setShowAttendance, setAttendanceInfo}) => {
    ...
    const { data: attendances, isLoading: attendanceLoading } = useGetAttendancesBySubject(
        'subject',
        pagination.limit,
        pagination.page,
    ...
    return (
        <AppDataTable 
            ...
            emptyText={'No subject attendance marked yet'}
